  ...
  return (
    <div className="px-4 xl:px-6">
      <div className="flex flex-wrap items-center justify-between gap-2 py-5">
        <h1 className="me-2 text-lg font-bold text-zinc-900 dark:text-zinc-200">
      ...
      <div className="overflow-hidden rounded-md bg-white shadow dark:bg-[#101010] dark:text-zinc-200">
        <div className="timeline">
          <Gantt
            ...
            listCellWidth="100px"
            barBackgroundColor={isDarkMode ? "#101010" : "#aeb8c2"}
            barBackgroundSelectedColor={isDarkMode ? "#181818" : "#9ba1a6"}
          />
        </div>
        <div className="px-4 pb-5 pt-1">
          <button
            className="flex items-center rounded bg-[#2563EB] px-3 py-2 text-white hover:bg-[#1D4ED8]"
